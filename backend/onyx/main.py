...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    from onyx.auth import jwks
    from onyx.auth import cdp_routes
    from onyx.auth import coinbase_auth
    
    include_router_with_global_prefix_prepended(application, jwks.router)
    include_router_with_global_prefix_prepended(application, cdp_routes.router)
    include_router_with_global_prefix_prepended(application, coinbase_auth.router)
