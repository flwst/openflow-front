...
import { MessageRenderer, RenderType, FullChatState } from "../interfaces";
...
export const CustomToolRenderer: MessageRenderer<
  CustomToolPacket,
  Pick<FullChatState, 'onSubmit'>
> = ({
  packets,
  onComplete,
  renderType,
  ...
  // Handle workflow_list response type
  if (responseType === "workflow_list") {
    return children({
      icon: FiTool,
      status: "Workflow Options Available",
      content: (
        <WorkflowSelector
