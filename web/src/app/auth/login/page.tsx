...
export default async function Page(props: PageProps) {
  // Redirect to Coinbase CDP authentication
  // This makes Coinbase the default login method
  redirect("/auth/coinbase");
}

// Original login page logic (kept for reference if needed)
async function OriginalLoginPage(props: PageProps) {
